...
const App = () => {
    ...
    const calculateAnalyticsData = () => {
        ...
        history.forEach(({ expression, probability }) => {
        ...
        const averageProbability = totalProbability / history.length;
    ...
    return (
        <div id="app" className="app">
            ...
            <div className="topSection">
                <div>
                    ...
                    <div className="graph_card">
                        ...
                        <canvas id="canvas" style={{ transform: "translate" }}></canvas>
                    </div>
                    ...
                    >
                        <svg style={{ fill: statusData[status]?.color }} class="wave" viewBox="0 0 1440 320" xmlns="http://www.w3.org/2000/svg">
                            <path
            ...
            <div className="summary" style={{ textTransform: "capitalize" }}>
                According to the data, this person's behavior indicates {analyticsData?.mostFrequentExpression} {statusData[analyticsData?.mostFrequentExpression]?.emoji}.
            </div>
        </div>
    );
};
